...
const validationSchema = Yup.object().shape({
  ...
  EventShift: Yup.string().required('Required'),
});
...
const CustomerBookingPage = ({route, navigation}) => {
  ...
  const saveData = async data => {
    ...
    let configurationObject = {
      ...
      data: {
        ...formData,
        CateringID: globalPayload.addons.CateringID,
        VenueID: globalPayload.venueId,
        userId: globalPayload.userId,
      },
    };
                ...
                {showCalendar ? (
                  <Overlay
                    ...
                    <CalendarComponent
                      ...
                      parentCallback={setEventDateMethod}
                    />
                  </Overlay>
                ) : null}
