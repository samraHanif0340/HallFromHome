      ...
      {props.error
        ? props.error.map(error => (
            <HelperText
              type="error"
              style={
                props.errorMsgStyle ? props.errorMsgStyle : styles.errorMsg
              }>
              {error}
            </HelperText>
          ))
...
const TextField = props => (
  <View>
    <View
      ...
      {props.nameOfIcon ? (
        <EvilIconsIcon
          name={props.nameOfIcon}
          style={styles.icon2}
          onPress={props.onPress}></EvilIconsIcon>
      ) : null}
      <TextInput
        onSubmitEditing={Keyboard.dismiss}
        style={props.textFieldStyle ? props.textFieldStyle : styles.textField}
    ...
    {props.error
      ? props.error.map((error, key) => (
          <HelperText
            type="error"
            style={props.errorMsgStyle ? props.errorMsgStyle : styles.errorMsg}
            key={key}>
            {error}
          </HelperText>
        ))
